...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/reservations')) {
            ...
            // bookRoom
            if (preg_match('#^/reservations/(?P<id_client>[^/]++)/(?P<id_room>[^/]++)/(?P<date_in>[^/]++)/(?P<date_out>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'bookRoom')), array (  '_controller' => 'AppBundle\\Controller\\ReservationsController::bookRoom',));
            }

            // cancel_booking
            if (0 === strpos($pathinfo, '/reservations/cancel') && preg_match('#^/reservations/cancel/(?P<id_reservation>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'cancel_booking')), array (  '_controller' => 'AppBundle\\Controller\\ReservationsController::cancelBooking',));
            }
