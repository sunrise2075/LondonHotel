...
class Client extends \AppBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'lastName', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'address', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'zipCode', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'city', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'state', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'reservations'];
        }
